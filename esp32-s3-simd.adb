...
with ESP32.S3.SIMD.F32;
with ESP32.S3.SIMD.I16;
with ESP32.S3.SIMD.I32;
with ESP32.S3.SIMD.I8;
with Interfaces;
use Interfaces;

package body ESP32.S3.SIMD is
   ...
   procedure Add (A, B : SIMD_I8_Vector; Result : in out SIMD_I8_Vector)
     ...
     renames ESP32.S3.SIMD.I8.Add;

   procedure Add (A, B : SIMD_I16_Vector; Result : in out SIMD_I16_Vector)

     renames ESP32.S3.SIMD.I16.Add;

   procedure Add (A, B : SIMD_I32_Vector; Result : in out SIMD_I32_Vector)

     renames ESP32.S3.SIMD.I32.Add;

   procedure Add (A, B : SIMD_F32_Vector; Result : in out SIMD_F32_Vector)

     renames ESP32.S3.SIMD.F32.Add;

   procedure Add_Scalar (A : SIMD_I8_Vector; Scalar : Integer_8;
                         Result : in out SIMD_I8_Vector)

     renames ESP32.S3.SIMD.I8.Add_Scalar;

   procedure Add_Scalar (A : SIMD_I16_Vector; Scalar : Integer_16;
                         Result : in out SIMD_I16_Vector)

     renames ESP32.S3.SIMD.I16.Add_Scalar;

   procedure Add_Scalar (A : SIMD_I32_Vector; Scalar : Integer_32;
                         Result : in out SIMD_I32_Vector)

     renames ESP32.S3.SIMD.I32.Add_Scalar;

   procedure Add_Scalar (A : SIMD_F32_Vector; Scalar : IEEE_Float_32;
                         Result : in out SIMD_F32_Vector)

     renames ESP32.S3.SIMD.F32.Add_Scalar;

   procedure Sub (A, B : SIMD_I8_Vector; Result : in out SIMD_I8_Vector)

     renames ESP32.S3.SIMD.I8.Sub;

   procedure Sub (A, B : SIMD_I16_Vector; Result : in out SIMD_I16_Vector)

     renames ESP32.S3.SIMD.I16.Sub;

   procedure Sub (A, B : SIMD_I32_Vector; Result : in out SIMD_I32_Vector)

     renames ESP32.S3.SIMD.I32.Sub;

   procedure Sub (A, B : SIMD_F32_Vector; Result : in out SIMD_F32_Vector)

     renames ESP32.S3.SIMD.F32.Sub;
   ...
   procedure Mul_Shift (A, B : SIMD_F32_Vector; Result : in out SIMD_F32_Vector;
                        Shift : Natural)
